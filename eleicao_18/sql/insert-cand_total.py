...
from lixo.con_spark import sqlContext
...
df_cand_total = df_cand_total.groupBy("cd_tipo_eleicao", "cd_eleicao", "sg_uf", "sg_ue", "cd_cargo", "nr_turno", "sq_candidato", "nr_candidato","nm_candidato", "nm_urna_candidato", "cd_situacao_candidatura", "cd_detalhe_situacao_cand", "nr_partido", "sq_coligacao", "ds_composicao_coligacao","cd_sit_tot_turno").sum("qt_votos_nominais")

# Renomeando a coluna do somatório de votos
df_cand_total= df_cand_total.withColumnRenamed("sum(qt_votos_nominais)", "sum_votos_total")
